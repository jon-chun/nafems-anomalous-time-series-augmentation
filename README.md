...
- [II. Introduction and Motivation](#ii-introduction-and-motivation)
  - [Problem statement](#problem-statement)
  - [Research goals](#research-goals)
- [III. Domain Knowledge](#iii-domain-knowledge)
  - [A. Bearing Fault Detection](#a-bearing-fault-detection)
    - [Vibration analysis](#vibration-analysis)
    - [Frequency transforms](#frequency-transforms) 
    - [Common fault types](#common-fault-types)
  - [B. Predictive Maintenance](#b-predictive-maintenance)
    - [Condition monitoring](#condition-monitoring)
    - [Remaining useful life estimation](#remaining-useful-life-estimation)  
- [IV. Literature Review](#iv-literature-review)
  - [A. Time Series Data Augmentation](#a-time-series-data-augmentation)
    - [Survey papers](#survey-papers)
    - [GANs, VAEs, etc.](#gans-vaes-etc)
  - [B. Time Series Anomaly Detection](#b-time-series-anomaly-detection)
    - [Classification methods](#classification-methods)
    - [Deep learning techniques](#deep-learning-techniques)
  - [C. Time Series Forecasting](#c-time-series-forecasting)
    - [Statistical methods](#statistical-methods)
    - [Neural network models](#neural-network-models)
  - [D. Time Series Generation](#d-time-series-generation)  
    - [VAEs, GANs, flows](#vaes-gans-flows)
    - [Evaluation metrics](#evaluation-metrics)
- [V. Datasets](#v-datasets)
  - [A. Public Data](#a-public-data)
    - [Case Western bearing data](#case-western-bearing-data) 
    - [Multivariate time series](#multivariate-time-series)
  - [B. Proprietary Data](#b-proprietary-data)
- [VI. Methods](#vi-methods)
  - [A. Data Preprocessing](#a-data-preprocessing)
  - [B. Feature Engineering](#b-feature-engineering)
  - [C. Model Development](#c-model-development)
    - [Architectures](#architectures)
    - [Loss functions](#loss-functions)
  - [D. Evaluation Metrics](#d-evaluation-metrics)
    - [Quantitative metrics](#quantitative-metrics)
- [VII. Experiments and Results](#vii-experiments-and-results)
  - [A. Public Benchmark Results](#a-public-benchmark-results)
  - [B. Proprietary Dataset Results](#b-proprietary-dataset-results)
  - [C. Synthetic Data Results](#c-synthetic-data-results)
- [VIII. Conclusion](#viii-conclusion)
  - [A. Summary](#a-summary)
  - [B. Limitations](#b-limitations)
  - [C. Future Work](#c-future-work)
...
- 3. Bearing Vibrational Code
  ...
  - (25 Jan 2022) PimW/Time-Series-Anomaly-Detection: Time series analysis using a grammar based compression algorithm. (github.com) Uses the discretization used for time series in PySAX and the grammar based compression of Sequitur as basis for the compression
  
Here is the continued outline in GitHub markdown format:
